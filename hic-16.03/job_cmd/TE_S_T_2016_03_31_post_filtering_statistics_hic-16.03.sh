#!/bin/bash
#$ -N TE_S_T_2016_03_31_post_filtering_statistics_hic-16.03
#$ -q short-sl65
#$ -l virtual_free=10G
#$ -l h_rt=6:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.03/job_out/TE_S_T_2016_03_31_post_filtering_statistics_hic-16.03_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.03/job_out/TE_S_T_2016_03_31_post_filtering_statistics_hic-16.03_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.03/job_cmd/TE_S_T_2016_03_31_post_filtering_statistics_hic-16.03.sh
