#!/bin/bash
#$ -N job_b1913e6c1_51720e9cf_2016_04_05_full_hic-16.03
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.03/job_out/job_b1913e6c1_51720e9cf_2016_04_05_full_hic-16.03_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.03/job_out/job_b1913e6c1_51720e9cf_2016_04_05_full_hic-16.03_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.03/job_cmd/job_b1913e6c1_51720e9cf_2016_04_05_full_hic-16.03.sh
