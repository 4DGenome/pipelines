#!/bin/bash
#$ -N job_cb6b65581_dc9651655_2016_09_13_downstream_bam_hic-16.05
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_cb6b65581_dc9651655_2016_09_13_downstream_bam_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_cb6b65581_dc9651655_2016_09_13_downstream_bam_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2016_09_13
pipeline_version=16.05
sample_id=cb6b65581_dc9651655
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=downstream_bam
io_mode=standard
CUSTOM_IN=/users/project/4DGenome/sequencing/2016-09-07
...
CUSTOM_OUT=/users/project/4DGenome/4DGenome_no_backup/data/hic/samples
PIPELINE=/users/project/4DGenome/pipelines/hic-16.05
config=pipelines/hic-16.05/hic.config
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_cb6b65581_dc9651655_2016_09_13_downstream_bam_hic-16.05.sh
