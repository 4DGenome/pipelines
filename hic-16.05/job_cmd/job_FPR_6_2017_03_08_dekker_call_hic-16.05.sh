#!/bin/bash
#$ -N job_FPR_6_2017_03_08_dekker_call_hic-16.05
#$ -q short-sl7
#$ -l virtual_free=20G
#$ -l h_rt=06:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_FPR_6_2017_03_08_dekker_call_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_FPR_6_2017_03_08_dekker_call_hic-16.05_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_FPR_6_2017_03_08_dekker_call_hic-16.05.sh
