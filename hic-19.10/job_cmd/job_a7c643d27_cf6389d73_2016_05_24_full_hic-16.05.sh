#!/bin/bash
#$ -N job_a7c643d27_cf6389d73_2016_05_24_full_hic-16.05
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_a7c643d27_cf6389d73_2016_05_24_full_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_a7c643d27_cf6389d73_2016_05_24_full_hic-16.05_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_a7c643d27_cf6389d73_2016_05_24_full_hic-16.05.sh
