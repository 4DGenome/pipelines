#!/bin/bash
#$ -N job_b1913e6c1_bb16b8aae_2016_06_21_full_hic-16.05
#$ -q mem_256
#$ -l virtual_free=200G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_b1913e6c1_bb16b8aae_2016_06_21_full_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_b1913e6c1_bb16b8aae_2016_06_21_full_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 20

submitted_on=2016_06_21
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_b1913e6c1_bb16b8aae_2016_06_21_full_hic-16.05.sh
