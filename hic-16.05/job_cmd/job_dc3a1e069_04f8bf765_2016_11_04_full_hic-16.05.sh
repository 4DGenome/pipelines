#!/bin/bash
#$ -N job_dc3a1e069_04f8bf765_2016_11_04_full_hic-16.05
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_dc3a1e069_04f8bf765_2016_11_04_full_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_dc3a1e069_04f8bf765_2016_11_04_full_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2016_11_04
pipeline_version=16.05
sample_id=dc3a1e069_04f8bf765
data_type=hic
pipeline_name=hic
pipeline_version=16.05
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_dc3a1e069_04f8bf765_2016_11_04_full_hic-16.05.sh
