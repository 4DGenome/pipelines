#!/bin/bash
#$ -N job_a7a9044d5_95a8cd511_2017_03_08_dekker_call_hic-16.05
#$ -q short-sl7
#$ -l virtual_free=20G
#$ -l h_rt=06:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_a7a9044d5_95a8cd511_2017_03_08_dekker_call_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_a7a9044d5_95a8cd511_2017_03_08_dekker_call_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2017_03_08
pipeline_version=16.05
sample_id=a7a9044d5_95a8cd511
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=dekker_call
io_mode=standard
CUSTOM_IN=/users/project/4DGenome/pipelines/hic-16.05/test
CUSTOM_OUT=/users/project/4DGenome
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_a7a9044d5_95a8cd511_2017_03_08_dekker_call_hic-16.05.sh
