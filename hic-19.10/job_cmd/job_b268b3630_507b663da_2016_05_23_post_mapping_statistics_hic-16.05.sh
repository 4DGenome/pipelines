#!/bin/bash
#$ -N job_b268b3630_507b663da_2016_05_23_post_mapping_statistics_hic-16.05
#$ -q short-sl65
#$ -l virtual_free=20G
#$ -l h_rt=06:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_b268b3630_507b663da_2016_05_23_post_mapping_statistics_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_b268b3630_507b663da_2016_05_23_post_mapping_statistics_hic-16.05_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_b268b3630_507b663da_2016_05_23_post_mapping_statistics_hic-16.05.sh
