#!/bin/bash
#$ -N job_9cecf0755_ac9f54f0a_2016_06_27_downstream_bam_hic-16.05
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_9cecf0755_ac9f54f0a_2016_06_27_downstream_bam_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_9cecf0755_ac9f54f0a_2016_06_27_downstream_bam_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2016_06_27
pipeline_version=16.05
sample_id=9cecf0755_ac9f54f0a
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=downstream_bam
io_mode=standard
CUSTOM_IN=/users/project/4DGenome/sequencing/2016-05-03
CUSTOM_OUT=/users/project/4DGenome/analysis/2016-05-03_run_hic-16.03_paula_soler/data/hic-16.05
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_9cecf0755_ac9f54f0a_2016_06_27_downstream_bam_hic-16.05.sh
