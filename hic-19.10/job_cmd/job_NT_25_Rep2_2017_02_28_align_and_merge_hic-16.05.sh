#!/bin/bash
#$ -N job_NT_25_Rep2_2017_02_28_align_and_merge_hic-16.05
#$ -q long-sl7
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_NT_25_Rep2_2017_02_28_align_and_merge_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_NT_25_Rep2_2017_02_28_align_and_merge_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2017_02_28
pipeline_version=16.05
sample_id=NT_25_Rep2
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=align_and_merge
io_mode=standard
CUSTOM_IN=/users/mmarti/psoler/FastQ
CUSTOM_OUT=/users/project/4DGenome/analysis/2017-02-20_run_hic-16.05_downsampled_fastqs_psoler/data
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_NT_25_Rep2_2017_02_28_align_and_merge_hic-16.05.sh
...
align_and_merge() {
	...
	echo "$python $SCRIPTS/map_process_merge.py $gem_index $SAMPLE $species $read_length $paired1 $paired2 $restriction_enzyme $fasta $slots $frag_map $version > $step_log"
