#!/bin/bash
#$ -N job_4a13fb79e_f34e98deb_2016_05_19_map_to_bam_hic-16.05
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_4a13fb79e_f34e98deb_2016_05_19_map_to_bam_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_4a13fb79e_f34e98deb_2016_05_19_map_to_bam_hic-16.05_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_4a13fb79e_f34e98deb_2016_05_19_map_to_bam_hic-16.05.sh
