#!/bin/bash
#$ -N job_cb6b65581_f34e98deb_2016_05_19_post_filtering_statistics_hic-16.05
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_cb6b65581_f34e98deb_2016_05_19_post_filtering_statistics_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_cb6b65581_f34e98deb_2016_05_19_post_filtering_statistics_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_05_19
pipeline_version=16.05
sample_id=cb6b65581_f34e98deb
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=post_filtering_statistics
io_mode=standard
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_cb6b65581_f34e98deb_2016_05_19_post_filtering_statistics_hic-16.05.sh
