#!/bin/bash
#$ -N merger_tadbit_T47D_0_Pg_15
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=24:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/merger_tadbit_T47D_0_Pg_15_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/merger_tadbit_T47D_0_Pg_15_$JOB_ID.err
#$ -j y
