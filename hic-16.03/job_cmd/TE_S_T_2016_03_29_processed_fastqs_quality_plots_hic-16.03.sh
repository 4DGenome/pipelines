#!/bin/bash
#$ -N TE_S_T_2016_03_29_processed_fastqs_quality_plots_hic-16.03
#$ -q short-sl65
#$ -l virtual_free=10G
#$ -l h_rt=6:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.03/job_out/TE_S_T_2016_03_29_processed_fastqs_quality_plots_hic-16.03_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.03/job_out/TE_S_T_2016_03_29_processed_fastqs_quality_plots_hic-16.03_$JOB_ID.err
#$ -j y
...
pipeline_name=hic
pipeline_version=16.03
pipeline_run_mode=processed_fastqs_quality_plots
io_mode=standard
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.03/job_cmd/TE_S_T_2016_03_29_processed_fastqs_quality_plots_hic-16.03.sh
...
processed_fastqs_quality_plots() {
	...
	ls $paired1
	ls $paired2
	echo $reads_number_qc
	echo $restriction_enzyme
