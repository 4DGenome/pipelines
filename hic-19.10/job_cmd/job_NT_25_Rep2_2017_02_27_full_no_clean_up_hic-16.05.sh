#!/bin/bash
#$ -N job_NT_25_Rep2_2017_02_27_full_no_clean_up_hic-16.05
#$ -q long-sl7
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_NT_25_Rep2_2017_02_27_full_no_clean_up_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_NT_25_Rep2_2017_02_27_full_no_clean_up_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2017_02_27
pipeline_version=16.05
sample_id=NT_25_Rep2
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=full_no_clean_up
io_mode=standard
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_NT_25_Rep2_2017_02_27_full_no_clean_up_hic-16.05.sh
