#!/bin/bash
#$ -N job_6ef597224_92b2943b1_2016_07_04_downstream_bam_hic-16.05
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_6ef597224_92b2943b1_2016_07_04_downstream_bam_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_6ef597224_92b2943b1_2016_07_04_downstream_bam_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2016_07_04
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_6ef597224_92b2943b1_2016_07_04_downstream_bam_hic-16.05.sh
