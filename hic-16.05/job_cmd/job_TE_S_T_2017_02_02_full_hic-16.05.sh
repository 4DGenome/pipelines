#!/bin/bash
#$ -N job_TE_S_T_2017_02_02_full_hic-16.05
#$ -q long-sl7
#$ -l virtual_free=20G
#$ -l h_rt=7:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_TE_S_T_2017_02_02_full_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_TE_S_T_2017_02_02_full_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2017_02_02
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_TE_S_T_2017_02_02_full_hic-16.05.sh
