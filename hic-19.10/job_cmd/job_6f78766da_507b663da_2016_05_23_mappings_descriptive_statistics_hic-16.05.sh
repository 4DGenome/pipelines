#!/bin/bash
#$ -N job_6f78766da_507b663da_2016_05_23_mappings_descriptive_statistics_hic-16.05
#$ -q short-sl65
#$ -l virtual_free=10G
#$ -l h_rt=06:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_6f78766da_507b663da_2016_05_23_mappings_descriptive_statistics_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_6f78766da_507b663da_2016_05_23_mappings_descriptive_statistics_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_05_23
pipeline_version=16.05
sample_id=6f78766da_507b663da
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=mappings_descriptive_statistics
io_mode=standard
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_6f78766da_507b663da_2016_05_23_mappings_descriptive_statistics_hic-16.05.sh
