#!/bin/bash
#$ -N job_2de4eaaf5_15cc93972_2016_12_13_full_hic-16.05
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/job_out/job_2de4eaaf5_15cc93972_2016_12_13_full_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/job_out/job_2de4eaaf5_15cc93972_2016_12_13_full_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2016_12_13
pipeline_version=16.05
sample_id=2de4eaaf5_15cc93972
data_type=hic
pipeline_name=hic
pipeline_version=16.05
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/job_cmd/job_2de4eaaf5_15cc93972_2016_12_13_full_hic-16.05.sh
