#!/bin/bash
#$ -N eaed0e91e_2a3b69a85_2016_04_04_full_hic-16.03
#$ -q long-sl65
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.03/job_out/eaed0e91e_2a3b69a85_2016_04_04_full_hic-16.03_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.03/job_out/eaed0e91e_2a3b69a85_2016_04_04_full_hic-16.03_$JOB_ID.err
#$ -j y
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.03/job_cmd/eaed0e91e_2a3b69a85_2016_04_04_full_hic-16.03.sh
